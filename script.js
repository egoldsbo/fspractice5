...
// Index to track which video is currently playing
...
function changeWordset() {
    ...
    shuffleArray(currentwordset);
    switchVideos();
    // Automatically load and play the first video from the new wordset
}
...
function openInNewTab(urlBase) {
    ...
    const choppedName = videoName.slice(0, -4);
    // Remove last 4 chars (.mp4)
